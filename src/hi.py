...
def main():
    ...
    newgraph.add_pair(1,2,3)
    newgraph.add_pair(2, 3, 3)
    newgraph.add_pair(3 ,4, 3)
    newgraph.add_pair(4, 1, 3)
    print(newgraph.all_nodes())
    print(newgraph.has_cycle())
    print(newgraph.fill_graph_randomly(40))
    print(newgraph.all_nodes())
    print(newgraph.has_cycle())
